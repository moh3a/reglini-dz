...
import Wilayas, { IWilaya } from "../../../data/Wilayas";

function classNames(...classes: any) {
  return classes.filter(Boolean).join(" ");
}

export default function SelectWilaya({ setWilaya }: any) {
  const [selected, setSelected] = useState<IWilaya>();
  useEffect(() => {
    if (selected) setWilaya(selected);
  }, [setWilaya, selected]);
