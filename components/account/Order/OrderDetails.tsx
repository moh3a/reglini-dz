...
const Details = ({ order, setOpenPayNow, setOpenTracking }: any) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col lg:flex-row justify-end py-2 px-3 text-black">
        {order.canCancel && (
          <div className="w-full flex justify-center">
            <button
              className="bg-red-200 px-4 py-1 my-1 rounded-lg hover:bg-red-300 dark:bg-red-400"
        ...
        {order.status &&
          ...
          !order.payment.receipt && (
            <div className="w-full flex justify-center">
              <button
                className="bg-indigo-200 px-4 py-1 my-1 rounded-lg hover:bg-indigo-300 dark:bg-indigo-400"
        ...
        <div className="w-full flex justify-center">
          <button
            className="bg-green-200 px-4 py-1 my-1 rounded-lg hover:bg-green-300 dark:bg-green-400"
