  ...
  return (
    <>
      ...
      <div className="my-10 mx-2 md:mx-20">
        ...
        <p>
          Welcome to <b>reglini-dz</b> (“we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>https://reglini-dz.com</b> (together or
          individually “Service”) operated by <b>reglini-dz</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>support@reglini-dz.com</b> so we can try to find a solution. These
        ...
        <p>
          We issue refunds for Contracts within <b>75 days</b> of the original
        ...
        <p>
          reglini-dz has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of reglini-dz or used with permission. You may not distribute, modify,
        ...
        <p>
          0.8. Otherwise attempt to interfere with the proper working of
          Service.
        </p>
        <p>
          8. <b>Analytics</b>
        ...
        <p>
          11. <b>Intellectual Property</b>
        </p>
        <p>
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of reglini-dz and its licensors. Service is protected by
          ...
          without the prior written consent of reglini-dz.
        </p>
        <p>
          12. <b>Copyright Policy</b>
        </p>
        <p>
        ...
        <p>
          ...
          to support@reglini-dz.com, with the subject line: “Copyright
        ...
        <p>
          13. <b>DMCA Notice and Procedure for Copyright Infringement Claims</b>
        </p>
        <p>
        ...
        <p>
          14. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at support@reglini-dz.com or via
          ...
          the Feedback; (ii) we may have development ideas similar to the
          ...
          reglini-dz is not under any obligation of confidentiality with respect
          to the Feedback. In the event the transfer of the ownership to the
          Feedback is not possible due to applicable mandatory laws, you grant
          us and its affiliates an exclusive, transferable, irrevocable,
        ...
        <p>
          15. <b>Links To Other Web Sites</b>
        </p>
        <p>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by reglini-dz.
        </p>
        <p>
          reglini-dz has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          CONTENT OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT YOUR
          USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS
          OBTAINED FROM US IS AT YOUR SOLE RISK.
        </p>
        <p>
          NEITHER US NOR ANY PERSON ASSOCIATED WITH US MAKES ANY WARRANTY OR
          ...
          US REPRESENTS OR WARRANTS THAT THE SERVICES, THEIR CONTENT, OR ANY
        ...
        <p>
          17. <b>Limitation Of Liability</b>
        </p>
        <p>
          ...
          LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF WE HAve BEEN PREVIOUSLY
          ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY
          LAW, IF THERE IS LIABILITY FOUND ON THE PART OF US, IT WILL BE LIMITED
          TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO
        ...
        <p>
          19. <b>Governing Law</b>
        </p>
        <p>
          These Terms shall be governed and construed in accordance with the
          laws of Algeria, which governing law applies to agreement without
        ...
        <p>
          22. <b>Waiver And Severability</b>
        </p>
        <p>
          ...
          waiver of any other term or condition, and any failure of us to assert
        ...
        <p>
          ...
          email: <b>support@reglini-dz.com</b>.
        </p>
      </div>
    </>
  );
