  ...
  return (
    <>
      ...
      <div className="my-10 mx-2 md:mx-20">
        ...
        <p>
          Welcome to <b> reglini-dz</b>.
        </p>
        <p>
          <b>reglini-dz</b> (“us”, “we”, or “our”) operates{" "}
          <b>https://reglini-dz.com</b> (hereinafter referred to as{" "}
          <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>https://reglini-dz.com</b>
        ...
        <p>
          <b>SERVICE</b> means the https://reglini-dz.com website operated by
          reglini-dz.
        </p>
        <p>
        ...
        <p>
          ...
          information: age, date of birth, citizenship, actual address,
          telephone number.
        </p>
        <p>
          5. <b>Use of Data</b>
        </p>
        <p>reglini-dz uses the collected data for various purposes:</p>
        ...
        <p>
          If you are located outside Algeria and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Algeria and process it there.
        </p>
        <p>
        ...
        <p>
          reglini-dz will take all the steps reasonably necessary to ensure that
        ...
        <p>
          ...
          us at <b>support@reglini-dz.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>support@reglini-dz.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>support@reglini-dz.com</b>.
        </p>
      </div>
    </>
  );
